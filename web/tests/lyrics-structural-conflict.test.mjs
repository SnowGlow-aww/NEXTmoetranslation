...
test("LyricsEditor turns malformed synced Yjs state into a terminal read-only conflict", async () => {
  ...
  assert.match(editor, /\u534f\u4f5c\u6587\u6863\u53d1\u751f\u7ed3\u6784\u51b2\u7a81\uff0c\u5df2\u5207\u6362\u4e3a\u53ea\u8bfb/);
  assert.match(editor, /\u7f16\u8f91\u4e0e\u4fdd\u5b58\u5df2\u505c\u7528/);
  assert.match(editor, /\u8bf7\u91cd\u65b0\u52a0\u8f7d\u5f53\u524d\u6b4c\u8bcd\uff1b\u82e5\u91cd\u65b0\u52a0\u8f7d\u540e\u4ecd\u51fa\u73b0\u6b64\u72b6\u6001\uff0c\u8bf7\u8054\u7cfb\u5176\u4ed6\u534f\u4f5c\u8005\u505c\u6b62\u7f16\u8f91/);
  assert.match(editor, /collaborationStructuralConflict && <button[\s\S]*?\u91cd\u65b0\u52a0\u8f7d\u6b4c\u8bcd<\/button>/);
  assert.match(editor, /!collaborationStructuralConflict && !localSourceImportDraft && collaborationStatus === "error"[\s\S]*reconnectNow\(\)/);
